...
export function Island({
  ...
  useFrame(() => {
    ...
    if (!isRotating) {
       ...
       *     full circle (354 degrees) so that it stays within the range of 0 to 2 * Math.PI.
  ...
  // const { nodes, materials } = useGLTF('/volcano_island_lowpoly.glb')
    ...
    <a.group  ref={islandRef} {...props}>
      ...
      <mesh
        ...
        position={[180.109, 1151.676, 5904.325]}
        rotation={[-Math.PI / 2, 0, 354.3]}
        scale={0.25}
      />
      <mesh
      ...
      <mesh
        ...
        position={[3541.67, 1110.094, 3548.021]}
        rotation={[-Math.PI / 2, 0, 354.3]}
        scale={0.25}
      />
      <mesh
    ...
    // {Island 3D model from: https://sketchfab.com/3d-models/foxs-islands-163b68e09fcc47618450250be7785907}
//     <a.group ref={islandRef} {...props}>
//       <mesh
